...
import 'package:shape/Lost.dart';
import 'package:shape/Result.dart';
...
final questions =  [
  ...
  {
    'questionText': 'Q9.  Which of the following command specifies where to find imported libraries.?',
    'answers': [
      {'text': ' -p', 'score': 100},
      {'text': '. -c', 'score': -50},
      {'text': ' -h', 'score': -50},
  ...
  {
    'questionText':
    'Q10. Dart programs run in _______ modes.?',
    'answers': [
      {'text': '2', 'score': 100},
      {'text': '5', 'score': -50},
      {'text': '3', 'score': -50},
        ...
        child: Column(
          children: [
            Expanded(child: Container(
              color:  const Color.fromRGBO(234,24,99,1),
              child: Center(
                //
                child:Text(Questions,style: const TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          style: const ButtonStyle(
                              backgroundColor: MaterialStatePropertyAll(Color.fromRGBO(24,25,30, 1))
                          ),
                          child: Text(AnswerA),
                          onPressed: (){
                            i++;
                            try {
                              ...
                              if(questions[i]!=5) {
                                ...
                                Questions += questions[i]['questionText'].toString();
                            ...
                            on RangeError{
                              if(Score >=500)
                              {
                              Questions=questions[0]['questionText'].toString();

                              Answers=questions[0]['answers']  as List ;
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) => WonScreen(Score)));
                              }
                              else
                              {
                              Questions=questions[0]['questionText'].toString();
                              ...
                              Answers=questions[0]['answers']  as List ;
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) => LoseScreen(Score)));
                              }
